...
optim_wrapper = dict(
    ...
    optimizer=dict(lr=0.003, type='AdamW', weight_decay=0.01),
    type='OptimWrapper')
param_scheduler = [
    dict(
        begin=0,
        ...
        pipeline=[
            ...
            dict(
                ...
                transforms=[
                    ...
                    dict(num_points=512, type='PointSample'),
                ],
...
work_dir = 'work_dirs/3dssd_4xb4_kitti-3d-car-custom/0417_16_256_512_0.003'
