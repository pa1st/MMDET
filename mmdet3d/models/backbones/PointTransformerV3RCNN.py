...
class PointTransformerV3RCNN(PointModule):
    def __init__(
        self,
        in_channels=6,
    ...
    def forward(self,tensor_3d):
        ...
        """
        batch_size, point_num, feat_num = tensor_3d.shape
        ...
        sa_features=point['feat'].reshape(batch_size, point_num, self.out_dim).permute(0, 2, 1)
        # sa_indices=torch.arange(0,point_num,1).repeat(2, 1)
        sa_xyz=sa_xyz.contiguous()
        sa_features=sa_features.contiguous()
        # print('sa_xyz:',sa_xyz,sa_xyz.shape)
        # print('sa_features',sa_features,sa_features.shape)
        # print('sa_incides',sa_indices,sa_indices.shape)
        res=dict(
            fp_xyz=sa_xyz,
            fp_features=sa_features
        )
        # print(point)
        # print(res)
        return res