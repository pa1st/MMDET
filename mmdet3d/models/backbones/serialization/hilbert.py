...
def encode(locs, num_dims, num_bits):
    ...
    Returns:
    --------
     The output_aut is an ndarray of uint64 integers with the same shape as the
...
def decode(hilberts, num_dims, num_bits):
    ...
    Returns:
    --------
     The output_aut is an ndarray of unsigned integers with the same shape as hilberts
